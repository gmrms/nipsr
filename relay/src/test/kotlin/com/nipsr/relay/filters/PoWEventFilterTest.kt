...
import com.nipsr.relay.filters.global.PoWEventFilter
...
class PoWEventFilterTest {
    ...
    @Test
    fun `should allow event that difficulty matches target`(){
        // given
    ...
    @Test
    fun `should not allow event that difficulty is greater than target`(){
        // given
    ...
    @Test
    fun `should not allow event that difficulty is lower than target`(){
        // given
